document.addEventListener('DOMContentLoaded', function() {
  ...
  function calculatePaintAmount() {
    ...
    document.getElementById('paintAmount').textContent = ` Inorder to paint ${width} X ${length} area with ${windows} windows and ${doors} doors You will need approximately ${paintNeeded.toFixed(2)} liters of paint.`}});